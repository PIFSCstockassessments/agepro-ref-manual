...
The two-stage recruits per spawning biomass model is a direct generalization of the $R/B_S$ model where the spawning stock of the population is categorized into “low” and “high” states. *The two-stage empirical recruits per spawning biomass distribution model depends
