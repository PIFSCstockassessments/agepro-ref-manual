...
|        |                              |   - $P_{1,1}, \quad P_{1,2}, \quad \dots, \quad P_{1,K}$  <br />                                          |
|        |                              |     $P_{2,1}, \quad P_{2,2}, \quad \dots, \quad P_{2,k}$  <br />                                          |
|        |                              |     $\quad \vdots \quad\quad \vdots \qquad\quad \vdots \qquad\quad \vdots$  <br />                        |
...
|        | Distribution                 | - On the next line, input the recruitments: $R_1,R_2,...,R_T$                                             |
+--------+------------------------------+-----------------------------------------------------------------------------------------------------------+
...
|        | Biomass Distribution         | - On the next line, input the low state recruitments: $R_1,R_2,...,R_{T_{Low}}$                           |
...
|        | Function of Recruitment      | - On the next line, input the low state recruitments: $R_1,R_2,...,R_{T_{Low}}$                           |
|        |                              | - On the next line, input the high state recruitments: $R_1,R_2,...,R_{T_{High}}$                         |
+--------+------------------------------+-----------------------------------------------------------------------------------------------------------+
...
|        |                              |   - $X_1(1), \quad\ \dots, \quad\ X_1(Y)$  <br />                                                         |
|        |                              |     $X_2(1), \quad\ \dots, \quad\ X_2(Y)$  <br />                                                         |
|        |                              |     $\ \vdots \qquad\qquad\ \ \vdots \qquad\quad\ \ \vdots$  <br />                                       |
...
|        |                              |   $1, ..., Y$                                                                                             |
|        |                              |   - $X_1(1) \quad X_1(2) \quad \dots \quad X_1(Y)$  <br />                                                |
|        |                              |     $X_2(1) \quad X_2(2) \quad \dots \quad X_2(Y)$  <br />                                                |
|        |                              |     $\quad \vdots \qquad\quad\ \vdots \qquad\quad \vdots \qquad\quad \vdots$  <br />                      |
