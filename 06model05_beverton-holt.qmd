...
The Beverton-Holt curve is often reparameterized in a modified form with parameters for steepness $h$ , unfished recruitment $R_0$, and unfished spawning biomass $B_0$. The modified Beverton-Holt curve produces $h \cdot R_0$ recruits when $B_S = 0.2B_0$ and has the form 
